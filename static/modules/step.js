...
layui.define(['form'], function (exports) {
    ...
    <div class="layui-inline" style="top:-5px">
        <input type="checkbox" name="trans.enabled." lay-skin="switch" lay-text="启用|禁用" checked>
    </div>
    <div class="layui-inline">
        <label class="layui-form-label-col">引擎:</label>
    </div>
    <div class="layui-inline width120">
        <select name="trans.engine." lay-filter="trans.engine"></select>
    </div>
    <div class="layui-inline width120">
        <select class="layui-select" name="trans.source." lay-search></select>
    </div>
    <div class="layui-inline">
    ...
    <div class="layui-inline width120">
        <select class="layui-select" name="trans.target." lay-search></select>
    </div>
    <div class="layui-inline">
        <label class="layui-form-label-col" style="color: #009688;">
    ...
    <div class="layui-inline width120">
        <select class="layui-select" name="trans.cfg_id." lay-search></select>
    </div>
...
layui.define(['form'], function (exports) {
    ...
    Class.prototype.add = function (field) {
        ...
        let id = this.getId(field['id']), // 索引
            dom = $(`<div class="layui-tab-item layui-show">
