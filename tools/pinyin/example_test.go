...
func ExampleConvert() {
	hans := "中国人"
	log.Println("default:", pinyin.Convert(hans, nil))
...
func ExamplePinyin_default() {
	hans := "中国人"
	a := pinyin.NewArgs()
	log.Println("default:", pinyin.Pinyin(hans, a))
	// Output: default: [[zhong] [guo] [ren]]
}
...
func ExamplePinyin_normal() {
	...
	log.Println("Normal:", pinyin.Pinyin(hans, a))
...
func ExamplePinyin_tone() {
	...
	a := pinyin.NewArgs()
	a.Style = pinyin.Tone
	log.Println("Tone:", pinyin.Pinyin(hans, a))
...
func ExamplePinyin_tone2() {
	...
	log.Println("Tone2:", pinyin.Pinyin(hans, a))
...
func ExamplePinyin_initials() {
	...
	log.Println("Initials:", pinyin.Pinyin(hans, a))
...
func ExamplePinyin_firstLetter() {
	...
	log.Println(pinyin.Pinyin(hans, a))
	// Output: [[z] [g] [r]]
}
...
func ExampleLazyPinyin() {
	hans := "中国人"
	a := pinyin.NewArgs()
	log.Println(pinyin.LazyPinyin(hans, a))
...
func ExampleSlug() {
	hans := "中国人"
	a := pinyin.NewArgs()
	log.Println(pinyin.Slug(hans, a))
	// Output: zhong-guo-ren
}
