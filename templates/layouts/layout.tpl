...
<head>
    ...
    <style>
        ...
        .layui-colla-item > .layui-colla-title{background-color:white;border:none}
        [data-event],[lay-event],[data-reboot]{cursor:pointer}
        .layui-layer,.layui-layer-content{border-radius:16px !important}
        .table-search{position:absolute;z-index:999;left:200px;top:22px}
        .table-search input{height:30px}
        textarea.layui-textarea{line-height:1.3rem;background-color:black;color:white}
        .slider-inline{margin-top:18px}
        ...
        i[lay-event=del],i[data-event=del]{color:red}
    </style>
