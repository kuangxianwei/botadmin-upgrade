        ...
        <div class="layui-row layui-col-space25">
            ...
            <div class="layui-col-md9">
                <div class="layui-form-item">
                    ...
                    <label class="layui-form-label" style="color: red;cursor: pointer" lay-filter="copy-urls">
                        <i class="layui-icon iconfont icon-copy"></i>复制URL列表</label>
                    <label class="layui-form-label" style="color: red;cursor: pointer" lay-filter="copy-keywords">
                        <i class="layui-icon iconfont icon-copy"></i>复制关键词列表</label>
