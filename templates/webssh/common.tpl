    ...
    <div class="layui-card-body layui-form" id="form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" autocomplete="off" name="alias" id="alias" placeholder="本机" value="{{.obj.Alias}}" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" autocomplete="off" name="host" id="host" placeholder="host" value="{{.obj.Host}}" class="layui-input" lay-verify="required">
                </div>
            </div>
            <div class="layui-inline">
                <label for="port" class="layui-form-label">Port:</label>
                <div class="layui-input-inline">
                    <input type="number" autocomplete="off" name="port" id="port" placeholder="port" value="{{.obj.Port}}" class="layui-input" lay-verify="required">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" autocomplete="off" name="user" id="user" placeholder="user" value="{{.obj.User}}" class="layui-input" lay-verify="required">
                </div>
            </div>
            <div class="layui-inline" id="auth">
                {{if eq .obj.Auth "pwd" -}}
                    ...
                    <div class="layui-input-inline">
                        <input type="password" autocomplete="off" name="passwd" id="passwd" placeholder="{{if eq .obj.Id 0 -}}SSH密码{{else}}留空为不修改密码{{end}}" value="" class="layui-input">
                    </div>
                {{else -}}
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" autocomplete="off" name="control_host" id="control_host" placeholder="默认填充为Host地址" value="{{.obj.ControlHost}}" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <label for="control_port" class="layui-form-label">控制台端口:</label>
                <div class="layui-input-inline">
                    <input type="number" autocomplete="off" name="control_port" id="control_port" value="{{.obj.ControlPort}}" class="layui-input">
                </div>
            </div>
        </div>
        ...
        form.on('radio(auth)', (obj) => {
            ...
            if (obj.value === "pwd") {
                authElem.html(`<label class="layui-form-label">Passwd:</label>
                    <div class="layui-input-inline">
                        <input type="password" autocomplete="off" name="passwd" id="passwd" placeholder="` + (defaultData.id === 0 ? "SSH密码" : "留空为不修改密码") + `" value="" class="layui-input">
                    </div>`);
            } else {
