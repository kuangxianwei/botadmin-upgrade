<div class="layui-card">
    <div class="layui-card-body layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="username" id="username" value="{{.obj.Username}}" lay-verify="required"
                       placeholder="3-12个字符" class="layui-input"{{if ne .obj.Id 0}} disabled{{end}}>
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="password2" id="password2" value="{{.obj.Password}}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="dir" id="dir" value="{{.obj.Dir}}"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="note" id="note" value="{{.obj.Note}}" placeholder="可选"
                       class="layui-input"/>
            </div>
        </div>
            ...
            <div class="layui-colla-item">
                ...
                <div class="layui-colla-content">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="ulbandwidth" id="ulbandwidth" value="{{.obj.Ulbandwidth}}"
                                   placeholder="为0则不限制" class="layui-input">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="dlbandwidth" id="dlbandwidth" value="{{.obj.Dlbandwidth}}"
                                   placeholder="为0则不限制" class="layui-input">
                        </div>
                        <div class="layui-form-mid layui-word-aux">单位为K</div>
                    </div>
        ...
        <div class="layui-form-item layui-hide">
            <input type="hidden" name="site_id" value="{{.obj.SiteId}}" disabled>
            <input type="hidden" name="id" value="{{.obj.Id}}" disabled>
