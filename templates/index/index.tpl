	...
	<div class="layui-layout layui-layout-admin">
		<div class="layui-header">
			...
			<ul class="layui-nav layui-layout-left">
				...
				<li class="layui-nav-item layui-hide-xs" lay-unselect>
					<input type="search" name="search" placeholder="搜索..." class="layui-input layui-input-search"
						...
						<dl class="layui-nav-child">
								...
								<dl class="layui-nav-child">
                                    {{range $system:=.systems -}}
										<dd data-name="site-{{$system.Driver}}">
											<a lay-href="/themes?driver={{$system.Driver}}" lay-tips="{{$system.Alias}}"
							...
							<dd data-name="remote-theme">
								...
								<dl class="layui-nav-child">
                                    {{range $system:=.systems -}}
										<dd data-name="site-{{$system.Driver}}">
											<a lay-href="/themes/shop?driver={{$system.Driver}}"
											   lay-tips="{{$system.Alias}}"
											   lay-direction="2"><cite>{{$system.Alias}}</cite></a>
										</dd>
                                    {{end -}}
								</dl>
					...
					<li data-name="sql" class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							...
							<dd data-name="sql-phpMyAdmin">
								<a href="{{.phpmyadmin}}" lay-tips="使用 phpmyadmin 管理" lay-direction="2"
								   target="_blank">
							...
							<dd data-name="twitter">
								...
								<dl class="layui-nav-child">
									...
									<dd data-name="twitter-user">
										<a lay-href="/twitter/user" lay-tips="推特账号列表" lay-direction="2">
											<i class="iconfont icon-list-view"></i>
											<cite>账号列表</cite>
										</a>
									</dd>
							...
							<dd data-name="mark">
								...
								<dl class="layui-nav-child">
									<dd data-name="mark-execute">
										<a lay-href="/mark" lay-tips="执行留痕" lay-direction="2">
											<i class="iconfont icon-list-view"></i>
											<cite>执行留痕</cite>
										</a>
									</dd>
									<dd data-name="mark-result">
										<a lay-href="/mark/result" lay-tips="留痕结果列表" lay-direction="2">
											<i class="iconfont icon-list-view"></i>
											<cite>结果</cite>
										</a>
									</dd>
									<dd data-name="mark-config">
										<a lay-href="/mark/config" lay-tips="留痕配置" lay-direction="2">
											<i class="iconfont icon-list-view"></i>
											<cite>配置</cite>
										</a>
									</dd>
					...
					<li data-name="file" class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							...
							<dd data-name="file-ssl">
								<a lay-href="/file?path=/usr/local/nginx/conf/ssl" lay-tips="管理SSL配置文件"
								   lay-direction="2">
									<cite>SSL配置文件</cite>
								</a>
							</dd>
					...
					<li data-name="safe" class="layui-nav-item">
						...
						<dl class="layui-nav-child">
							...
							<dd data-name="safe-firewall">
								<a lay-href="/safe/waf" lay-tips="网络防火墙WAF" lay-direction="2">
