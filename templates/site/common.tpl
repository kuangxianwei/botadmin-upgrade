			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show">
					<div class="layui-form-item">
						...
						<div class="layui-inline">
							...
							<div class="layui-input-block">
								<select name="tpl_name" lay-filter="tpl_name" lay-search>
									<option value="">搜索...</option>
                                    {{range $k,$v:=.tplNames -}}
										<option value="{{$v}}"{{if eq $v $.obj.TplName}} selected{{end}}>{{$v}}</option>
                                    {{end -}}
								</select>
							</div>
						</div>
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							<label for="vhost" class="layui-form-label">站点域名<i class="iconfont icon-about"
																				   lay-tips="不带http://，创建后不可修改"></i>:</label>
							<div class="layui-input-inline">
								<input type="text" name="vhost" id="vhost" required lay-verify="vhost"
						...
						<div class="layui-inline">
							<label for="binds" class="layui-form-label">绑定域名<i class="iconfont icon-about"
																				   lay-tips="多个请用英文逗号,分隔"></i>:</label>
							<div class="layui-input-block">
								<input type="text" name="binds" id="binds" class="layui-input"
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" name="indexes" id="indexes" class="layui-input"
								   value="{{join .obj.Indexes ","}}"
					...
					<div class="layui-form-item">
						<label for="unlimited_bind" class="layui-form-label">泛域名<i class="iconfont icon-about"
																					  lay-tips="对泛域名的支持，一般不需要开启"></i>:</label>
						<div class="layui-input-inline">
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							<label for="sql_enabled" class="layui-form-label">SQL<i class="iconfont icon-about"
																					lay-tips="是否启用数据库，如果启用又不选择则自动创建"></i>:</label>
							<div class="layui-input-block">
								<input type="checkbox" name="sql_enabled" id="sql_enabled" lay-skin="switch"
									   lay-text="启用|禁用"{{if .obj.SqlEnabled}} checked{{end}}>
							</div>
						</div>
						<div class="layui-inline">
					...
					<div class="layui-form-item">
						<div class="layui-inline">
							<label for="ftp_enabled" class="layui-form-label">FTP<i class="iconfont icon-about"
																					lay-tips="是否启用FTP，如果启用又不选择则自动创建"></i>:</label>
							<div class="layui-input-block">
								<input type="checkbox" name="ftp_enabled" id="ftp_enabled" lay-skin="switch"
									   lay-text="启用|禁用"{{if .obj.FtpEnabled}} checked{{end}}>
							</div>
						</div>
						<div class="layui-inline">
				...
				<div class="layui-tab-item">
						...
						<div class="layui-form-item">
							<div class="layui-row">
								<div class="layui-col-sm6">
									...
									<div class="layui-input-block">
										<input type="text" name="web_user" id="web_user" value="{{.obj.WebUser}}"
											   class="layui-input" placeholder="3-15个字符">
									</div>
								</div>
								<div class="layui-col-sm5">
									<label for="web_pwd" class="layui-form-label"
										   lay-tips="由6-15个字符组成">密码:</label>
									<div class="layui-input-block">
										<input type="text" name="web_pwd" id="web_pwd" value="{{.obj.WebPwd}}"
					...
					<fieldset class="layui-elem-field">
							...
							<div class="layui-row layui-col-space10">
								...
								<div class="layui-col-sm4">
									<label for="subtitle" class="layui-form-label"
										   lay-tips="每个网页的标题后缀 如:南方39助孕网">副标题:</label>
									<div class="layui-input-block">
										<input type="text" name="subtitle" id="subtitle" value="{{.obj.Subtitle}}"
											   class="layui-input" placeholder="39助孕网">
									</div>
								</div>
								<div class="layui-col-sm1">
								...
								<div class="layui-col-sm6">
									...
									<div class="layui-input-block">
										<input type="text" name="keywords" id="keywords"
											   value='{{join .obj.Keywords ","}}'
											   class="layui-input" placeholder="关键词1,关键词2">
									</div>
								</div>
								<div class="layui-col-sm5">
									<label for="description" class="layui-form-label">Tags:</label>
									<div class="layui-input-block">
										<textarea name="tags" class="layui-textarea"
												  placeholder="TAG 一行一个">{{join .obj.Tags "\n"}}</textarea>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="layui-col-sm10">
									...
									<div class="layui-input-block">
										<input type="text" name="description" id="description"
											   ...
											   class="layui-input" placeholder="网站描述">
									</div>
								</div>
								<div class="layui-col-sm1">
						...
						<div class="layui-form-item">
							...
							<input type="hidden" name="classes" value="{{print .obj.Classes }}" required
								   lay-verify="classes">
						...
						<div class="layui-form-item">
							<div class="layui-row">
								<div class="layui-col-sm6">
									...
									<div class="layui-input-inline">
										<input type="text" name="auth_code" id="auth_code" value="{{.obj.AuthCode}}"
											   data-type="fill" class="layui-input" placeholder="登录第二验证码">
									</div>
								</div>
								<div class="layui-col-sm5">
									<label for="admin_dir" class="layui-form-label" lay-tips="网站后台登录目录名称">后台目录:</label>
									<div class="layui-input-block">
										<input type="text" name="admin_dir" id="admin_dir" class="layui-input"
							...
							<div class="layui-row">
								<div class="layui-col-sm6">
									<label for="class_num" class="layui-form-label"
										   lay-tips="一般栏目数量设置不超过10个">栏目数量:</label>
									<div class="layui-input-block">
										<input type="text" name="class_num" id="class_num" class="layui-input"
											   value="{{.obj.ClassNum}}" placeholder="8">
									</div>
								</div>
								<div class="layui-col-sm5">
									<label for="city" class="layui-form-label"
										   lay-tips="选择城市必须是实际存在的">城市:</label>
									<div class="layui-input-block">
						...
						<div class="layui-form-item">
							<div class="layui-row">
								<div class="layui-col-sm6">
									<label for="wap_enabled" class="layui-form-label"
										   lay-tips="网站广告代码一般为js代码">广告:</label>
									<div class="layui-input-block">
										<textarea name="ad" class="layui-textarea"
												  placeholder="网站广告代码一般为js代码">{{.obj.Ad}}</textarea>
									</div>
								</div>
						...
						<div class="layui-form-item">
							<div class="layui-col-sm6">
								<label for="wap_enabled" class="layui-form-label"
									   lay-tips="李谊:139-2235-2985 一行一条">联系方式:</label>
								<div class="layui-input-block">
									<textarea name="contact" class="layui-textarea"
											  placeholder="李谊:139-2235-2985&#13;韩晶:135-3983-5229">{{join .obj.Contact "\n"}}</textarea>
								</div>
							</div>
							<div class="layui-col-sm6">
								<label for="wap_enabled" class="layui-form-label"
									   lay-tips="灰词=>替换成的是词 一行一条">灰词替换:</label>
								<div class="layui-input-block">
									<textarea name="replaces" class="layui-textarea"
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<textarea name="about" class="layui-textarea"
										  placeholder="站群cms系统,单站站群,支持批量发布,批量处理,建站养站自动采集站群管理系统,全自动批量操作,可批量采集英中互译,优化内容,统一管理模式,提供完整的解决方案,一人轻松管理数百个网站">{{.obj.About}}</textarea>
							</div>
						</div>
					</fieldset>
				</div>
				<div class="layui-tab-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" name="wap_host" id="wap_host" value="{{.obj.WapHost}}"
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" name="wap_root_dir" id="wap_root_dir" class="layui-input"
								   value="{{.obj.WapRootDir}}"
								   placeholder="m">
						</div>
				...
				<div class="layui-tab-item">
					<fieldset class="layui-elem-field">
						...
						<div class="layui-form-item">
							...
							<input name="err400" id="err400" type="checkbox"
								   title="400" {{if .obj.Err400}} checked{{end}}/>
							<input name="err401" id="err401" type="checkbox"
								   title="401" {{if .obj.Err401}} checked{{end}}/>
							<input name="err403" id="err403" type="checkbox"
								   title="403" {{if .obj.Err403}} checked{{end}}/>
							<input name="err404" id="err404" type="checkbox"
								   title="404" {{if .obj.Err404}} checked{{end}}/>
							<input name="err405" id="err405" type="checkbox"
								   title="405" {{if .obj.Err405}} checked{{end}}/>
							<input name="err500" id="err500" type="checkbox"
								   title="500" {{if .obj.Err500}} checked{{end}}/>
							<input name="err503" id="err503" type="checkbox"
								   title="503" {{if .obj.Err503}} checked{{end}}/>
						</div>
					</fieldset>
					<fieldset class="layui-elem-field">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-inline">
								<input type="text" name="redirects_url" id="redirects_url" value="{{.obj.RedirectsUrl}}"
					...
					<fieldset class="layui-elem-field">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="safe_img_type" id="safe_img_type" value="{{.obj.SafeImgType}}"
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="allow_domains" id="allow_domains" value="{{.obj.AllowDomains}}"
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="safe_img_src" id="safe_img_src" value="{{.obj.SafeImgSrc}}"
				...
				<div class="layui-tab-item">
					...
					<div class="layui-form-item">
						<div class="layui-row">
							<div class="layui-col-md6">
								...
								<div class="layui-input-inline">
									<input type="text" name="pic_dir" id="pic_dir" value="{{.obj.PicDir}}"
										   class="layui-input"/>
								</div>
								<div class="layui-form-mid layui-word-aux">
									<a lay-href="/file?path=data/pic/{{.obj.PicDir}}"
									   lay-text="默认图片">点击添加或删除图片</a>
								</div>
							</div>
							<div class="layui-col-md6">
								<label for="pub_interval" class="layui-form-label">发布间隔:</label>
								<div class="layui-input-inline">
									<input type="number" min="100" name="pub_interval" id="pub_interval"
										   value="{{.obj.PubInterval}}" class="layui-input"/>
								</div>
					...
					<div class="layui-form-item layui-row">
						<div class="layui-col-md2">
							...
							<div class="layui-input-block">
								<input type="checkbox" name="pic_autoed" id="pic_autoed" lay-skin="switch"
				...
				<div class="layui-tab-item">
					<div class="layui-form-item">
						<div class="layui-inline">
							<label for="scan_enabled" class="layui-form-label">扫描病毒<i class="iconfont icon-about"
																						  lay-tips="根据定时规则启动对网站文件定时扫描"></i>:</label>
							<div class="layui-input-inline">
								<input type="checkbox" name="scan_enabled" id="scan_enabled" lay-skin="switch"
									   lay-text="启用|禁用" title="启用|禁用"{{if .obj.ScanEnabled}} checked{{end}}>
							</div>
						</div>
						<div class="layui-inline">
							<label for="scan_spec" class="layui-form-label">定时规则<i class="iconfont icon-about"
																					   lay-tips="定时扫描,默认为每天扫描一次，双击修改定时任务"></i>:</label>
							<div class="layui-input-inline">
								<input type="text" name="scan_spec" id="scan_spec" value="{{.obj.ScanSpec}}"
									   class="layui-input">
							</div>
						</div>
					</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="number" name="port" id="port" value="{{.obj.Port}}" class="layui-input"
								   placeholder="80">
						</div>
						<div class="layui-form-mid layui-word-aux">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="number" name="conn" id="conn" class="layui-input" value="{{.obj.Conn}}"
								   placeholder="0">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="number" name="conn_speed" id="conn_speed" class="layui-input"
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" name="try_proxy" id="try_proxy" class="layui-input"
								   value="{{.obj.TryProxy}}" placeholder="https://www.nfivf.com">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<textarea name="others" id="others" class="layui-textarea" rows="7"
									  placeholder="{&quot;tag_limit&quot;:10,&quot;tag_show&quot;:0}">{{print .obj.Others }}</textarea>
						</div>
					</div>
				</div>
			</div>
