    ...
    <div class="layui-card-body layui-form">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="host" lay-verify="required" class="layui-input" placeholder="服务器地址" value="{{.obj.Host}}">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="username" lay-verify="required" class="layui-input" placeholder="邮箱用户名" value="{{.obj.Username}}">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="password" name="password" lay-verify="required" class="layui-input" placeholder="邮箱登录密码" value="{{.obj.Password}}">
            </div>
