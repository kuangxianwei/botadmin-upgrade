<div class="layui-card">
    <div class="layui-card-body layui-form" id="tencent">
        ...
        <div class="layui-form-item">
            <label for="app_id" class="layui-form-label" lay-tips="翻译平台获取">SecretId:</label>
            <div class="layui-input-block">
                <input type="text" name="app_id" id="app_id" value="{{.obj.AppId}}" lay-verify="required"
                       placeholder="翻译平台获取" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            <label for="token" class="layui-form-label" lay-tips="翻译平台获取">SecretKey:</label>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="delay" id="delay" value="{{print .obj.Delay}}" placeholder="输入秒"
                       class="layui-input">
            </div>
            <div class="layui-form-mid layui-word-aux">每次请求间隔多少秒</div>
        </div>
        <div class="layui-form-item">
            <label for="region" class="layui-form-label">服务区域:</label>
            <div class="layui-input-inline">
                <select name="region" id="region" class="layui-select">
                    {{range $v:=.regions -}}
