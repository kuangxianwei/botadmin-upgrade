			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show layui-form">
					<div class="layui-form-item layui-row">
						<div class="layui-col-md3">
							...
							<div class="layui-input-block">
								<input type="text" name="username" id="username" value="{{.base.Username}}"
						...
						<div class="layui-col-md3">
							...
							<div class="layui-input-block">
								<input type="text" name="addr" id="addr" value="{{.base.Addr}}" class="layui-input"
						...
						<div class="layui-col-md3">
							...
							<div class="layui-input-block">
								<input type="number" name="port" id="port" value="{{.base.Port}}" class="layui-input"
									   placeholder="8080">
							</div>
						</div>
					</div>
					<div class="layui-form-item layui-row">
						...
						<div class="layui-col-md3">
							...
							<div class="layui-input-block">
								<input type="checkbox" name="gzip_enabled" id="gzip_enabled" lay-skin="switch"
					...
					<div class="layui-form-item">
						...
						<div class="layui-inline">
							...
							<div class="layui-input-inline">
								<input type="number" name="ad_cache" id="ad_cache" value="{{.base.AdCache}}" min="0"
									   class="layui-input">
							</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="checkbox" name="pprof" id="pprof" lay-skin="switch"
								   lay-text="打开|关闭"{{if .base.Pprof}} checked{{end}}>
						</div>
					...
					<div class="layui-form-item layui-row">
						<div class="layui-col-md5">
							...
							<div class="layui-input-block">
								<input type="text" name="php_my_admin_name" id="php_my_admin_name"
									   value="{{.base.PhpMyAdminName}}" class="layui-input">
							</div>
						</div>
						<div class="layui-col-md5">
						...
						<div class="layui-colla-item">
							...
							<div class="layui-colla-content layui-show">
								...
								<div class="layui-form-item layui-row">
									<div class="layui-col-md6">
										<label class="layui-form-label"
											   lay-tips="登录错误次数超过将限制N分钟后登录,0为不限制录">登录限制:</label>
										<div class="layui-input-block">
									...
									<div class="layui-col-md6">
										<label class="layui-form-label"
											   lay-tips="浏览器同时开启最多个数,同时开启太多会卡死">浏览器:</label>
										<div class="layui-input-block">
								...
								<div class="layui-form-item layui-row">
									<div class="layui-col-md6">
										<label class="layui-form-label"
											   lay-tips="同时开启采集器的最大限制">采集限制:</label>
										<div class="layui-input-block">
									...
									<div class="layui-col-md6">
										<label class="layui-form-label"
											   lay-tips="同时发布文章的最大限制">发布限制:</label>
										<div class="layui-input-block">
				...
				<div class="layui-tab-item layui-form">
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="nginx_path" type="text" name="nginx_path" value="{{.server.NginxPath}}"
								   class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="nginx_conf_path" type="text" name="nginx_conf_path"
								   value="{{.server.NginxConfPath}}" class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						<label for="rewrite_path" class="layui-form-label">伪静态目录:</label>
						<div class="layui-input-block">
							<input id="rewrite_path" type="text" name="rewrite_path" value="{{.server.RewritePath}}"
								   class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="mysql_ini" type="text" name="mysql_ini" value="{{.server.MysqlIni}}"
								   class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="php_ini" type="text" name="php_ini" value="{{.server.PhpIni}}"
								   class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
				...
				<div class="layui-tab-item layui-form">
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input id="password" type="text" name="password" value="{{.spider.Password}}"
								   class="layui-input">
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="radio" name="originality" value="0"
								   title="不检验"{{if eq .spider.Originality 0}} checked{{end}}>
							<input type="radio" name="originality" value="1"
								   title="未检验"{{if eq .spider.Originality 1}} checked{{end}}>
							<input type="radio" name="originality" value="2"
								   title="已检验"{{if eq .spider.Originality 2}} checked{{end}}>
						</div>
					</div>
					<div class="layui-form-item">
						<label for="tag_enabled" class="layui-form-label">Tags:</label>
						<div class="layui-input-inline">
							<input type="checkbox" id="tag_enabled" name="tag_enabled" lay-skin="switch"
								   lay-text="打开|关闭"{{if .spider.TagEnabled}} checked{{end}}>
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="checkbox" id="correct_enabled" name="correct_enabled" lay-skin="switch"
								   lay-text="打开|关闭"{{if .spider.CorrectEnabled}} checked{{end}}>
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="checkbox" id="description_enabled" name="description_enabled" lay-skin="switch"
								   lay-text="打开|关闭"{{if .spider.DescriptionEnabled}} checked{{end}}>
						</div>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="api_key" type="text" name="api_key" value="{{.spider.ApiKey}}"
								   class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
				...
				<div class="layui-tab-item layui-form">
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="checkbox" id="ban_tag_enabled" name="tag_enabled" lay-skin="switch"
								   lay-text="打开|关闭" title="打开|关闭"{{if .ban.TagEnabled}} checked{{end}}>
						</div>
						<div class="layui-form-mid layui-word-aux">启用获取tags</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="ban_api_key" type="text" name="api_key" value="{{.ban.ApiKey}}"
								   class="layui-input">
						</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input id="ban_secret" type="text" name="secret" value="{{.ban.Secret}}"
								   class="layui-input">
						</div>
					</div>
				...
				<div class="layui-tab-item layui-form">
							...
							<div class="layui-inline">
								...
								<div class="layui-input-inline">
									<input type="checkbox" name="enabled" id="enabled" lay-skin="switch"
										   lay-text="启用|关闭"{{if .monitor.Enabled}} checked{{end}}>
								</div>
							</div>
							<div class="layui-inline">
								<label for="spec" class="layui-form-label">Spec:</label>
								<div class="layui-input-inline" lay-tips="双击修改定时任务">
									<input type="text" name="spec" id="spec" value="{{.monitor.Spec}}"
										   class="layui-input">
								</div>
							</div>
					...
					<div style="text-align: center">
						<div class="layui-btn-group">
							...
							<button class="layui-btn" lay-event="crontab" data-value="monitor_service"
									lay-tips="查看定时监控服务状态">
								查看状态
							</button>
						</div>
				...
				<div class="layui-tab-item layui-form">
					<div class="layui-form-item">
						<textarea class="layui-textarea"
								  placeholder="# sub_filter_once off;&#10;# sub_filter_types text/html;&#10;# sub_filter 捐精 助孕;&#10;# sub_filter 代孕 助孕;"
								  name="sub_filter" rows="16">{{.subFilter}}</textarea>
					</div>
					<div class="layui-form-item">
						<label class="layui-form-label"></label>
						<div class="layui-btn-group">
