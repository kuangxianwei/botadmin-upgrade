     ...
     if((!!window.ActiveXObject || "ActiveXObject" in window)){
         ...
         if (!isAndroid && !isiOS) {
             ...
             $(window).scroll(function(){
                 ...
                 } else if(scrollTop + windowHeight >= scrollHeight - 150){    //滚动到底部
...
function weixinstatus() {
      var ddid=$(".paybox-img").attr("out_trade_no");
	    if (ddid) {
	    jQuery.support.cors = true;
	    $.get("/e/payapi/pcweixin/ajax.php?tradeno=" + ddid+'&hc='+ new Date().getTime(),function(data,status){
        if(data=="1"){
          //window.location.href = "/e/payapi/pcweixin/success.php"; //页面跳转
          $(".marks").css("display",'none');
          $(".marks").remove();
          alert('支付成功,您已经获得复制和下载权限。');
        }
      });
      }
}
...
function zhifu(){
    ...
    if(cs.search(/( |^|;)[a-zA-Z]{5,12}jhcdd=BuyGroupPay+/)>0){
       $.get("/e/payapi/pcweixin/ajax.php?time="+new Date().getTime());
    }
     jQuery.support.cors = true;
    $.post(
        "/e/payapi/pcweixin/zhifu.php",
        data,
        function(html){
...
function payload(ddid){
  layer.open({
    type: 1,
    title:false,
    area: ['300px', '370px'],
    content: '<div class="wx_top"><span>支付处理中，请勿关闭窗口</span></div><div class="payqr_box" style="display: block;"><div class="hc" style="display: block;"><img src="/e/ecmsshop/paycopy/css/wxzhifu_load.gif"></div><div class="zhifu"><div class="sm">支付处理中，请勿关闭窗口</div></div></div><div class="payqr_success_box" style="display: none;"><div class="payqr_success_text"><svg class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1629"><path d="M511.993344 0.002048C229.260838 0.002048 0 229.261862 0 511.998464c0 282.732506 229.259814 511.990272 511.993344 511.990272C794.73097 1023.987712 1023.988736 794.73097 1023.988736 511.998464c0-282.736602-229.257766-511.996416-511.995392-511.996416zM788.582942 397.083376L475.699087 709.96723C464.321548 721.341697 449.189043 727.145665 434.1702 727.145665c-15.018843 0-30.036662-5.687233-41.527863-17.177411l-157.23859-157.241662c-22.982403-22.865668-22.982403-60.072299 0-83.054702 22.982403-22.982403 60.074347-22.86874 83.05675 0l115.823366 115.710727 271.352919-271.357015c22.871812-22.86874 60.074347-22.86874 83.05675 0 22.871812 22.983427 22.871812 60.189034-0.11059 83.057774z" fill="" p-id="1630"></path></svg><span class="text">支付成功</span><span class="text small">已获得该文章复制权限</span><button class="buy-btn" onclick="layer.closeAll();">确定</button></div></div>' 
  });
  payzt=setInterval("paystatus()", 2000);
}

function paystatus() {
      //开始查询订单付款状态
      $.post("/e/payapi/h5weixin/jhc.php",{enews:"getzt",ddno:ddid},function(data){
        var obj = eval( "(" + data + ")" );
          if(!ddid)ddid=$.cookie("jhcdd"); //jhc  202105
        if(obj.zt=="ok"){
			//vivo=true;
          $.cookie("iscopy"+obj.id,"1", { expires:30, path: '/'})
          $(".payqr_box").hide();
          $(".payqr_success_box").show();
...
function GetRequest() {  
   //var url = location.search; //获取url中"?"符后的字串20210331注释
   var url=location.search.replace(/\?ivk_sa=(.+?)\?/,'?');//20210331
...
function checkcopy(){
  var wzid=$("#content").attr("wzid");
  var iscopy=$.cookie("iscopy"+wzid);
  //if(vivo)return true;
  if(!iscopy || iscopy=="NULL"){
    ...
    title:false,
    area: ['80%', '360px'],
    content: '<div class="copy-goods"><div class="houhao_top"><span>付费后即刻复制</span></div><div class="paybox-img"><img src="/e/ecmsshop/paycopy/css/pay.jpg"></div><div><span class="now-price">限时特价:4.99元/篇</span><span class="org-price">原价10元</span></div><a class="paybox-buy-copy pay-btn" href="/e/payapi/copypay.php?payid=5&id='+wzid+'&reurl='+nowurl+'">微信支付</a><div class="fanfabuzhou1">1、点击微信支付</div><div class="fanfabuzhou2">2、唤起微信APP</div><div class="fanfabuzhou2">3、支付后自动返回复制全文</div><div class="paybox-cservice">如需帮助，点此联系客服</div></div>' 
  });
    connectkf();
    return false;
  } else {
...
function connectkf(){
   var nowurl=window.location.href;
  //var ddno=$.cookie("gwiqojhcdd");
  //console.log("nowurl:"+nowurl)
  //console.log("ddno:"+ddno)
  var ddid=$.cookie("jhcdd"); //jhc  202105
  var nowurl=window.location.href;
  var ddno=$.cookie("bcyrijhcdd");
  console.log("nowurl:"+nowurl)
  console.log("ddno:"+ddno)
  $(".paybox-cservice").click(function(){
    layer.open({
    type: 1,
    title:false,
    area: ['300px', '390px'],
    content: '<div class="phone-pic"><span class="kefu-msg">付费成功后仍无法复制，可能是浏览器兼容问题或网络繁忙，请刷新页面试下。</span><span class="copy-txt-btn"><a href="'+nowurl+'?ddno='+ddid+'" target="_self">点此刷新</a></span><span class="kefu-more">如需帮助请联系客服，长按微信号可复制</span><span class="kefu-title">客服微信号</span><span class="kefu-name">2261362615</span></div><div class="phone-art"><span>在线时间：周一至周五</span><span>9:00-12:30  14:00-18:30  </span><span>周六 9:00-12:30 </span></div>' 
  });
  });
}