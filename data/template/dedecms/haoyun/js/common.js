...
//动态加载js
var includeJS = function (src,callBack){
    var js = document.createElement("script");
    js.src = src;
    js.type="text/javascript";
    var fatDOM = (document.getElementsByTagName("head"))?document.getElementsByTagName("head")[0]:document.body;
    fatDOM.appendChild(js);
    if (typeof callBack =="function"){
        //ie
        if(navigator.appName.indexOf("Microsoft") != -1){
            js.onreadystatechange = function () {
                if (js.readyState == 'loaded' || js.readyState == 'complete') callBack.call();
            }
        }
        //非ie
        else{
            js.onload = function(){callBack.call()};
        }
    }
}
...
nowmonth = tmpDate.getMonth()+1;
nowday = tmpDate.getDate();

var pailuan = function(){
    ...
    function GetCalendarOuterHTML(CalendarIndex,HaveLayer){
        ...
        CalendarOuterHTML = CalendarOuterHTML + "<table border='0' cellspacing='0' cellpadding='3' align='center' id=Calendar"+CalendarIndex+ ">";
        ...
        CalendarOuterHTML = CalendarOuterHTML + "<tr class='dtitle2'><td width='18'>日<td width='18'>一<td width='18'>二<td width='18'>三<td width='18'>四<td width='18'>五<td width='18'>六";
    ...
    function DisplayCalendar(){
        ...
        MM_showHideLayers('Layer_Ovu','','show');
    }
    //Initialize
...
var slide = function (o1,o2,o3,o4,o5,o6){/*切换图,切换按钮,按钮现时样式,切换时间,默认位置,鼠标事件(click,mouseover)*/
    var pica = $(o1)
    var picNava = $(o2)
    var onclass = o3
    var ctime = o4
...
var resetday = function(){
    ...
    $(".inpDay").val(nowday)
    $(".sDate").html(nowyear +"-"+ nowmonth +"-"+ nowday)
}
...
var com = function(){
    $(".inpTxts").click(function(){
        if($(".inpTxts").val() == "怀孕初期症状"){
            $(".inpTxts").val("")
        }
    });
    $(".inpTxts").mouseout(function(){
        if($(".inpTxts").val() == ""){
            $(".inpTxts").val("怀孕初期症状")
        }
    });

    $("#foot").html('关于好孕网 | <a href="/" target="_blank">我要投稿</a> | <a href="/" target="_blank">联系我们</a><br>本网站所有资料均为作者提供和网友推荐收集整理而来，仅供学习和研究使用。如有侵犯你版权的，请来信指出，本站将立即改正。<br>Copyright @ 2008 - 2015 Haoyunbb Inc. All Rights Reserved<br />daiyun139.com 版权所有 <a href="http://www.miitbeian.gov.cn/" target="_blank">粤ICP备11098989号</a>');
    ...
    if(navigator.appName == "Microsoft Internet Explorer"){
     ...
     function addcounter(o){
     $(o).click(function(){
     var tohref = $(o).attr("href")
     $("body").append('')
     })
     }
if($("#hzh").length>0){
...
var tops = function(){
    $("#top").html('<div class="dToplist">孕妇工具|怀孕工具<ul class="ulToplist"><li>·<a href="/tools/1.html" target="_blank">排卵期计算器</a></li><li>·<a href="/tools/2.html" target="_blank">预产期计算器</a></li><li>·<a href="/tools/3.html" target="_blank">孩子血型测试</a></li><li>·<a href="/tools/4.html" target="_blank">宝宝身高计算器</a></li><li>·<a href="/tools/5.html" target="_blank">生男生女预测</a></li><li>·<a href="/tools/6.html" target="_blank">胎儿体重估测</a></li><li>·<a href="/tools/7.html" target="_blank">孕期检查跟踪</a></li><li>·<a href="/tools/8.html" target="_blank">孕期体重范围</a></li><li>·<a href="/tools/9.html" target="_blank">基础体温曲线</a></li><li>·<a href="/tools/10.html" target="_blank">宝宝身高体重标准表</a></li></ul></div><div class="bdsharebuttonbox"><a class="bds_more" href="#" data-cmd="more"></a><a title="分享到QQ空间" class="bds_qzone" href="#" data-cmd="qzone"></a><a title="分享到新浪微博" class="bds_tsina" href="#" data-cmd="tsina"></a><a title="分享到腾讯微博" class="bds_tqq" href="#" data-cmd="tqq"></a><a title="分享到人人网" class="bds_renren" href="#" data-cmd="renren"></a><a title="分享到微信" class="bds_weixin" href="#" data-cmd="weixin"></a></div>');
    $(".dToplist").each(function(i){
        $(this).hover(function(){
            $(".ulToplist").eq(i).show()
        },function(){
            $(".ulToplist").eq(i).hide()
...
var sc = "<a href=\"javascript:window.open(\'http:\/\/shuqian.qq.com\/post?from=3&title=\'+encodeURIComponent(document.title)+\'&uri=\'+encodeURIComponent(document.location.href)+\'&jumpback=2&noui=1\',\'favit\',\'\');void(0)\">QQ<\/a> <a href=\"javascript:window.open(\'http:\/\/cang.baidu.com\/do\/add?it=\'+encodeURIComponent(document.title.substring(0,76))+\'&iu=\'+encodeURIComponent(location.href)+\'&fr=ien#nw=1\',\'_blank\',\'\'); void 0\">百度<\/a>"

var share = function(){
    $(".dShare").html('<div class="bdsharebuttonbox"><a class="bds_more" href="#" data-cmd="more"></a><a title="分享到QQ空间" class="bds_qzone" href="#" data-cmd="qzone"></a><a title="分享到新浪微博" class="bds_tsina" href="#" data-cmd="tsina"></a><a title="分享到腾讯微博" class="bds_tqq" href="#" data-cmd="tqq"></a><a title="分享到人人网" class="bds_renren" href="#" data-cmd="renren"></a><a title="分享到微信" class="bds_weixin" href="#" data-cmd="weixin"></a></div> 收藏到：'+sc);
}


var sharetxt = function(fat){
    ...
    fatDom.mouseup(function(e){
        var str=funcGetSelectText();
        if(str!=""){
            selected_status=true;
            if(shareObj.length==0){
                shareObj=$('<div>',{
                    html:'<em>分享到：</em><span></span>',
                    "class":'dShare_txt',
                    "id":'sharetxt'
                });
                shareObj.appendTo($(document.body));
            }


            var alink = function(){
                if (window.location.href.indexOf("?") == -1){
                    return window.location.href+"?share=2."
                }
                else{
                    return window.location.href+"&share=2."
                }
            }
            var alink2 = encodeURIComponent(alink())
            var t = encodeURIComponent(str+'（来源：南方代孕www.daiyun139.com）')

            var html

            html = '<a class="aShare aShare_tSina" href="http://service.t.sina.com.cn/share/share.php?c=nie&content=gb2312&pic=&source=nie&sourceUrl='+alink2+'tsina&title='+t+'&url='+alink2+'tsina" target="_blank" title="新浪微博"></a>'
            html += "<a class='aShare aShare_qzone' href='http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url="+alink2+"qzone&pics=&summary="+t+"' target='_blank' title='QQ空间'></a>"
            html += "<a class='aShare aShare_tqq' href='http://v.t.qq.com/share/share.php?url="+alink2+"tqq&site=www.daiyun139.com&title="+t+"' target='_blank' title='QQ微博'></a>"
            html += '<a class="aShare aShare_renren" href="http://share.renren.com/share/buttonshare.do?title='+t+'&link='+alink2+'renren" target="_blank" title="人人"></a>'
            html += '<a class="aShare aShare_pengyou" href="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?to=pengyou&url='+alink2+'pengyou&pics=&summary='+t+'" target="_blank" title="朋友"></a>'
            html += "<a class='aShare aShare_t163' href='http://t.163.com/article/user/checkLogin.do?link="+alink2+"t163&source="+t+"&info="+t+alink2+"t163' target='_blank' title='网易微博'></a> "

            shareObj.find("span").html(html)
            shareObj.css({
                left:e.pageX-50,
                top:e.pageY+15
            }).show();
...
var desktop = function(){
    ...
    html = '<p class="dDesktop">'
    html += "<a class='aBut aBut_1' href='http://www.daiyun139.com/desktop.php?url="+alink+"&title="+t+"' target='_blank'>保存本文</a>"
    html += "<a class='aBut aBut_2' href='http://www.daiyun139.com/desktop.php' target='_blank'>【推荐】保存好孕网到桌面快捷方式，方便下次使用！</a>"
    html += '</p>'
...
var addlink = function(){
    ...
    var title = $(".h1Art").html()
    //$(".dArt p").eq(0).append("<strong class='hide'><a href='"+href+"' target='_blank'>"+ title +"</a>。</strong>")
    var htmltitle = $(".dArt p").eq(0).html()
    htmltitle = htmltitle.replace('。',"。<strong class='hide'><a href='"+href+"' target='_blank'>"+ title +"</a>。</strong>")
    $(".dArt p").eq(0).html(htmltitle)

    $(".dArt").append("<p>来源：<a href='"+href+"' target='_blank'>"+ href +"</a></p>")

    var ls = String(window.location)

    var linktitle = {
        "/":"怎样才能怀孕，怎么样才能怀孕，什么时候最容易受孕",
        "/":"产后多久能同房，剖腹产后多久可以同房，生完孩子多久可以同房"
    }
    var tg2
    for (var i in linktitle){
        if(ls.indexOf(i) != -1){
            tg2 = "<a href='"+i+"' target='_blank'>"+linktitle[i]+"</a>"
            var html = $(".dArt p").eq(1).html()
            html = html.replace('。','。<span class="hide">'+tg2+'。</span>')
            $(".dArt p").eq(1).html(html)
        }
    }

    var tg
    $(".dArt p").eq(1).append("<span class='hide'>"+tg+"。</span>")
}


function getUrlName(_) {
    var lhref = String(window.location.href),
        B = new RegExp("(^|)" + _ + "=([^&]*)(&|$)", "gi").exec(lhref),A;
    if (A = B) return A[2];
    else return 0;
}
var srcto = function(){
    if(getUrlName('src')!=0){
        location.href= getUrlName('src')
    }
}

var tab40weeks = function(o1,o2){
    var tabgo
    $(o1).each(function(i){
        $(this).hover(function(){
            tabgo = setTimeout(function(){
                $(o1).removeClass("current")
                $(o1).eq(i).addClass("current")
                $(o2).removeClass("current")
    ...
    var lhref = String(window.location.href)
    $(o2).find("a").each(function(i){
        if(lhref.indexOf($(this).attr("href"))>=0){
            $(this).addClass("aNow")
            $(this).parent(".con").addClass("current")
            $(o1).eq(Math.floor(i/4)).addClass("current")
        }
    })
}

var yun10nav = function(){
    if($("#dZtNavbg").length > -1){
        $("#dZtNavbg").toggle(function(){
            $("#dZtNavbg").addClass("current")
            $("#dZtNav").addClass("current")
        },function(){
            $("#dZtNavbg").removeClass("current")
            $("#dZtNav").removeClass("current")
        })
    }
}

var index = function(){
    slide("#f_imgDiv .con","#f_buttonDiv a","current",3000,0,"mouseover")
    tops()
    pailuan()
    yuchanqi()
    resetday()
...
var list = function(){
    ...
    //gg_960("#gg_960_1",14)
    //gg_960_2("#gg_960_1",1)
    //$("#gg_250_2").html($("#span_gg_250_2").html())
    //$("#gg_250_3").html($("#span_gg_250_3").html())
    //$("#gg_250_4").html($("#span_gg_250_4").html())
}
...
var art = function(){
    ...
    //gg_960_2("#gg_960_1",1)
    //gg_kh("#gg_670_1",1)
    //$("#gg_670_1").html($("#span_gg_670_1").html())
    //$("#gg_670_2").html($("#span_gg_670_2").html())
    //$("#gg_250_2").html($("#span_gg_250_2").html())
    //$("#gg_250_3").html($("#span_gg_250_3").html())
    //$("#gg_250_4").html($("#span_gg_250_4").html())
}

var baodianlist = function(){
    tops()
    //gg_960("#gg_960_1",14)
    //gg_960_2("#gg_960_1",1)
}

var baodianart = function(){
    tops()
    share()
    addlink()
    desktop()
...
var listbbs = function(){
    tops()
    share()
    $("#list-bbs li").each(function(i){
        if(i%2 ==1){
            $(this).addClass("li_2")
        }
    })
    var showbbsli = function(){
        $("#list-bbs li").each(function(i){
            if(parseInt(($(this).offset()).top)< parseInt($(window).scrollTop() +$(window).height()) ){
...
var yun40weeks = function(){
    tops()
    share()
    desktop()
    //sharetxt(".dArt")
    tab40weeks(".ulTab_40weeks li",".dTabcon_40weeks .con")
}
...
//统计
/*document.write('<script src="http://s4.cnzz.com/stat.php?id=1320957&web_id=1320957" language="JavaScript"></script>');*/
document.writeln("<script src=\"http:\/\/js.users.51.la\/17468116.js\"><\/script>");

/*百度分享*/
window._bd_share_config={"common":{"bdSnsKey":{},"bdText":"","bdMini":"2","bdMiniList":false,"bdPic":"http://g.hiphotos.bdimg.com/wisegame/pic/item/f3ef76c6a7efce1b8ecceaa7ae51f3deb58f65f3.jpg","bdStyle":"0","bdSize":"24"},"share":{},"image":{"viewList":["qzone","tsina","tqq","renren","weixin"],"viewText":"分享到：","viewSize":"24"},"selectShare":{"bdContainerClass":null,"bdSelectMiniList":["qzone","tsina","tqq","renren","weixin"]}};with(document)0[(getElementsByTagName('head')[0]||body).appendChild(createElement('script')).src='http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion='+~(-new Date()/36e5)];
