...
$(function(){var numpic=$('#slides li').size()-1;var nownow=0;var inout=0;var TT=0;var SPEED=5000;var ulstart='<ul id="pagination"><div class="main"><div class="mainv">',ulcontent='',ulend='</div></div></ul>';ADDLI();var pagination=$('#pagination li');var paginationwidth=$('#pagination').width();pagination.eq(0).addClass('current')
