...
if(SmallPicsID){
	if(this.$(SmallPicsID)){
		...
		for(i=0;i<this.Data.length;i++){
			...
			var num=i+1;
			temp+="<span"+(this.adNum==i?' class="selected"':"")+"><a onmouseover=\"FocusPic.childs["+this.ID+"].select("+i+")\"  href=\""+this.Data[i][2]+"\" target=\"_blank\">"+ num +"</a></span>"
