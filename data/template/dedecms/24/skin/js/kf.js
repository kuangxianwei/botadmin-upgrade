	...
	var hz6d_from_page = hz6d_getCookie("53kf_70826083_keyword");
	var kf_70826083_keyword_ok = hz6d_getCookie("kf_70826083_keyword_ok");
	if (kf_70826083_keyword_ok != 1)
	{
		hz6d_from_page = document.referrer;
	}
	hz6d_setCookie("53kf_70826083_keyword",hz6d_from_page);
	hz6d_setCookie("kf_70826083_keyword_ok",1);
	...
	function hasdoctype()
  {
	...
	function setIsinvited()
	{
		try
		{
			...
			if (acc_autotype == 3)
			{
				document.cookie = "onliner_zdfq70826083=" + onliner_zdfq;
			}
		}
		catch (e)
		{}
	}
	var onliner_zdfq = hz6d_getCookie("onliner_zdfq70826083"); // onliner_zdfq: 0.初始值 2.点击接受 3.点击拒绝 
	if (onliner_zdfq == "")
	{
		onliner_zdfq = 0;
		document.cookie = "onliner_zdfq70826083=" + onliner_zdfq;
	...
	// 加载ivt.php，即中间的接受邀请层 
	if (!hz6d$("ivt_script"))
		document.write("<scr"+"ipt src='http://www22.53kf.com/kf_ivt.php?arg=chj01&test_do=&style=1&isonline=0&kfonline=0&lang=zh-cn&resize=yes&charset=gbk&kflist=on&kf=001,003,chj01,008&zdkf_type=1"+ hz6d_referer + hz6d_from_page + "&lytype=0&tpl_name=crystal_blue&tpl_width=703&tpl_height=473' type='text/javascript' id='ivt_script'></scr"+"ipt>");  
	...
	if (kf_script_num <= 1)
  {
      ...
      for (var i = 0; i < element_arrs.length; i++)
      {
        ...
        else
        {
					switch (tmp_e_type)
          {
            ...
            case 'etel': click_str = 'window.open(\'http://chat.53kf.com/eht.php?company_id=70826083&style_id=103774916\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')'; break;
            case 'qq':
    ...
    var input_name_arr = input_name_str.split('#'); // 初始化解码数组 
          ...
          if ("1,\u5916\u6846,-,156,267,-,-,1,-,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#2,\u5934\u90e8\u80cc\u666f,-,156,174,0,0,1,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702560.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#3,\u5e95\u90e8\u80cc\u666f,-,156,31,0,236,3,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702696.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#4,53KF\u80cc\u666f,chat,156,31,0,174,4,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313704648.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#5,\u5728\u7ebf\u5f62\u8c61,chat,121,120,17,49,8,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1437389417.jpg,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#6,53KF,chat,106,22,36,179,9,-,no-repeat,-,-,zdy,\u6211\u662f\u5a77\u5a77,14,0059AB,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#7,\u5ba2\u670dLOGO,-,22,20,9,8,13,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1418699691.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#8,\u6807\u9898,-,120,24,30,6,14,-,no-repeat,-,-,zdy,\u6709\u95ee\u9898\u70b9\u6211\u54e6\uff01,14,FFFFFF,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#9,\u7248\u6743\u6240\u6709,-,156,31,0,236,15,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1418699094.jpg,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank#10,400\u80cc\u666f,-,156,31,0,205,16,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313710747.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank#11,400\u7535\u8bdd,-,106,22,36,209,17,-,no-repeat,-,-,zdy,4006-833-884,14,0059AB,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank" == '' || "1,\u5916\u6846,-,156,267,-,-,1,-,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#2,\u5934\u90e8\u80cc\u666f,-,156,174,0,0,1,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702560.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#3,\u5e95\u90e8\u80cc\u666f,-,156,31,0,236,3,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702696.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#4,53KF\u80cc\u666f,qq,156,31,0,174,4,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1438167044.jpg,no-repeat,-,1835610427,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#5,\u5728\u7ebf\u5f62\u8c61,qq,121,120,17,49,8,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1438167446.jpg,no-repeat,-,1835610427,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#6,53KF,qq,106,22,36,179,9,-,no-repeat,-,1835610427,zdy,\u9648\u9f991835610427,14,0059AB,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#7,\u5ba2\u670dLOGO,-,22,20,9,8,13,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1418699691.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#8,\u6807\u9898,-,120,24,30,6,14,-,no-repeat,-,-,zdy,\u6709\u95ee\u9898Q\u6211\u5427\uff01,14,FFFFFF,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#9,\u7248\u6743\u6240\u6709,-,156,31,0,236,15,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1418699094.jpg,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank#10,400\u80cc\u666f,-,156,31,0,205,16,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313710747.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank#11,400\u7535\u8bdd,-,106,22,36,209,17,-,no-repeat,-,-,zdy,15918847118,14,0059AB,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank" == ''  || "yes" == 'no')
          {
      ...
      function _getClickUrl()
      {
        ...
        return _click_str;
			...
			function _closeIcon()
			{
				...
				{
					str_onmove = "onmousemove='this.style.backgroundImage=\"url(http://www22.53kf.com/img/kflist/list_close_move.gif)\"' onmouseout='this.style.backgroundImage=\"url(http://www22.53kf.com/img/kflogo/close.gif)\"'";
				}
				if (1 == 1 || 70826083 == 600603 || 70826083 == 61393572 || 70826083 == 1413303 || 70826083 == 61389920 || 70826083 == 61420906 || 70826083 == 61578368)
				{
					if (2 == 1)
					{
						//return "<img onclick='kf_icons["+this.config["id"]+"].hidden()' style='position:absolute; right:0px;top:0px; cursor:pointer;' src='http://www22.53kf.com/img/kflogo/close.gif' "+str_onmove+" />";
						...
						return "<div onclick='kf_icons[" + this.config["id"] + "].hidden()' style='" + str_wh + "background:url(\"http://www22.53kf.com/img/kflogo/close.gif\") no-repeat;position:absolute;right:0px;top:0px;cursor:pointer;' " + str_onmove + " ></div>";
					}
					//return "<img onclick='kf_icons["+this.config["id"]+"].hidden()' style='position:absolute; right:0px;top:0px; cursor:pointer;' src='http://www22.53kf.com/img/kflogo/close.gif' />";
					return "<div onclick='kf_icons[" + this.config["id"] + "].hidden()' style='width:11px;height:11px;background:url(\"http://www22.53kf.com/img/kflogo/close.gif\") no-repeat;position:absolute;right:0px;top:0px;cursor:pointer;' ></div>";
				}
				return "";
			};
		...
		kf_icons[kf_icon_id].config["arg"] = "chj01";
		//kf_icons[kf_icon_id].config["logo_id"]="1088";
    ...
    if (2 == 2)kf_icons[kf_icon_id].config["zdytb_on_arrs"] = init_zdytb_arr("1,\u5916\u6846,-,156,267,-,-,1,-,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#2,\u5934\u90e8\u80cc\u666f,-,156,174,0,0,1,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702560.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#3,\u5e95\u90e8\u80cc\u666f,-,156,31,0,236,3,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702696.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#4,53KF\u80cc\u666f,chat,156,31,0,174,4,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313704648.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#5,\u5728\u7ebf\u5f62\u8c61,chat,121,120,17,49,8,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1437389417.jpg,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#6,53KF,chat,106,22,36,179,9,-,no-repeat,-,-,zdy,\u6211\u662f\u5a77\u5a77,14,0059AB,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#7,\u5ba2\u670dLOGO,-,22,20,9,8,13,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1418699691.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#8,\u6807\u9898,-,120,24,30,6,14,-,no-repeat,-,-,zdy,\u6709\u95ee\u9898\u70b9\u6211\u54e6\uff01,14,FFFFFF,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#9,\u7248\u6743\u6240\u6709,-,156,31,0,236,15,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1418699094.jpg,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank#10,400\u80cc\u666f,-,156,31,0,205,16,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313710747.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank#11,400\u7535\u8bdd,-,106,22,36,209,17,-,no-repeat,-,-,zdy,4006-833-884,14,0059AB,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank");
    if (2 == 2)kf_icons[kf_icon_id].config["zdytb_off_arrs"] = init_zdytb_arr("1,\u5916\u6846,-,156,267,-,-,1,-,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#2,\u5934\u90e8\u80cc\u666f,-,156,174,0,0,1,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702560.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#3,\u5e95\u90e8\u80cc\u666f,-,156,31,0,236,3,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313702696.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#4,53KF\u80cc\u666f,qq,156,31,0,174,4,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1438167044.jpg,no-repeat,-,1835610427,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#5,\u5728\u7ebf\u5f62\u8c61,qq,121,120,17,49,8,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1438167446.jpg,no-repeat,-,1835610427,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#6,53KF,qq,106,22,36,179,9,-,no-repeat,-,1835610427,zdy,\u9648\u9f991835610427,14,0059AB,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#7,\u5ba2\u670dLOGO,-,22,20,9,8,13,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1418699691.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#8,\u6807\u9898,-,120,24,30,6,14,-,no-repeat,-,-,zdy,\u6709\u95ee\u9898Q\u6211\u5427\uff01,14,FFFFFF,center,-,-,-,\u5b8b\u4f53,none,-,-,-,_blank#9,\u7248\u6743\u6240\u6709,-,156,31,0,236,15,\/img\/upload\/chj01\/zdytb\/zdytb_53kf_1418699094.jpg,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank#10,400\u80cc\u666f,-,156,31,0,205,16,\/img\/kflogo\/zdytb\/new2011_01\/zdytb_53kf_1313710747.gif,no-repeat,-,-,-,-,12,-,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank#11,400\u7535\u8bdd,-,106,22,36,209,17,-,no-repeat,-,-,zdy,15918847118,14,0059AB,left,-,-,-,\u5b8b\u4f53,none,-,-,http:\/\/www.znbo.com,_blank");
		kf_icons[kf_icon_id].config["img_on"] = "http://www22.53kf.com/img/kflogo/pink.gif";
		kf_icons[kf_icon_id].config["img_off"] = "http://www22.53kf.com/img/kflogo/pink_off.gif";
		kf_icons[kf_icon_id].config["height"] = "267";
		...
		kf_icons[kf_icon_id].config["offsetH"] = parseInt("460");
		...
		kf_icons[kf_icon_id].config["kf"] = "&kflist=on&kf=001,003,chj01,008&zdkf_type=1";
		...
		var hz6d_zdyurl = "?arg=chj01&style=1&kflist=on&kf=001,003,chj01,008&zdkf_type=1&language=zh-cn&charset=gbk&lytype=0&referer={hz6d_referer}{hz6d_keyword}&tpl=crystal_blue";
